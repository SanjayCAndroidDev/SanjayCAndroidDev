...
import com.jesvardo.app.network.model.ModelResponseUserDeatils
...
class ProfileViewModel : BaseViewModel() {
    ...
    var getUserDetails = MutableLiveData<ModelResponseUserDeatils>()

    fun getUserDetails(strUserID: String) {
        var strToken = "Bearer " + appPreferences.getAppPrefString(AppConstants.PREF_USER_TOKEN)
        subscription = postApi.getUserDetails(strToken, strUserID)
